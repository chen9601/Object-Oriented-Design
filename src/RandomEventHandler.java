...
public class RandomEventHandler
{
    ...
    public void RandomEventIndicator(int player_num, int event_num)
    {
        switch(event_num)
        {
            case 0:
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev1(int player_num)
    {
        String message="당신은 비밀결사의 집회가 오늘 밤 이곳에서 열린다는 것을 들었다.";
        ShowDialog(message);                                                                    
        String answer1="1. 참가한다.";
        String answer2="2. 참가하지 않는다.";
        ShowDialogAnswer(answer1,"1_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"1_2",player_num);
    }
    /**
     * 랜덤 이벤트1-서브1
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev1_sub1(int player_num)
    {
        String message="\"고통은 인간을 계몽시키지.\" 비밀 결사의 교주가 말한다. \"동의하는가?\"";
        ShowDialog(message);                                                                    
        String answer1="1. 동의한다.";
        String answer2="2. 동의하지 않는다.";
        ShowDialogAnswer(answer1,"1_1_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"1_1_2",player_num);
    }
        /**
     * 랜덤 이벤트2
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev2(int player_num)
    {
        String message="정체를 알 수 없는 메아리 소리에 마음이 불안해졌습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 소리가 닿지 않는 곳으로 숨는다.";
        String answer2="2. 소리가 들리는 곳으로 따라간다.";
        ShowDialogAnswer(answer1,"2_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"2_2",player_num);
    }
    /**
     * 랜덤 이벤트3
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev3(int player_num)
    {
        String message="파이트 클럽의 회원들이 당신에게 비무장 싸움을 제안합니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 싸운다.";
        String answer2="2. 싸우지 않는다.";
        ShowDialogAnswer(answer1,"3_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"3_2",player_num);
    }
        /**
     * 랜덤 이벤트4
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev4(int player_num)
    {
        String message="기차역에서 터번을 둘러쓰고 얼굴에서 광기가 느껴지는 한 사람이 내렸습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 다가간다.";
        String answer2="2. 지켜본다.";
        String answer3="3. 자리를 떠난다.";
        ShowDialogAnswer(answer1,"4_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"4_2",player_num);
        ShowDialogAnswer(answer3,"4_3",player_num);
    }
        /**
     * 랜덤 이벤트5
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev5(int player_num)
    {
        String message="상점 뒤쪽을 어슬렁거리는 중에 뒤에서 소음이 들립니다. ";
        ShowDialog(message);                                                                    
        String answer1="1. ?!";
        ShowDialogAnswer(answer1,"5_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트6
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev6(int player_num)
    {
        String message="기이한 조각상이 있다는 소문을 듣습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 조각상을 조사한다.";
        String answer2="2. 무시한다.";
        ShowDialogAnswer(answer1,"6_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"6_2",player_num);
    }
    /**
     * 랜덤 이벤트7
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev7(int player_num)
    {
        String message="기차역의 화물 적재 플랫폼에서 기이한 문장이 있는 커다란 상자를 발견했습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 상자를 열어본다.";
        String answer2="2. 떠난다.";
        ShowDialogAnswer(answer1,"7_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"7_2",player_num);
    }
    /**
     * 랜덤 이벤트8
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev8(int player_num)
    {
        String message="신문사에서 신비한 이야기를 제보받고 있습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 제보한다.";
        String answer2="2. 제보하지 않는다.";
        ShowDialogAnswer(answer1,"8_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"8_2",player_num);
    }
    /**
     * 랜덤 이벤트9
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev9(int player_num)
    {
        String message="\"우리 조직에 들어오겠소?\" 파이트 클럽의 회원들이 당신을 둘러싸며 묻습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. 수락한다.";
        String answer2="2. 거절한다.";
        ShowDialogAnswer(answer1,"9_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"9_2",player_num);
    }
    /**
     * 랜덤 이벤트10
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev10(int player_num)
    {
        ...
        ShowDialog(message);                                                                    
        String answer1="1. 그를 구한다.";
        String answer2="2. 기억나지 않는 사람이다. 내버려둔다.";
        ShowDialogAnswer(answer1,"10_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"10_2",player_num);
    }
    /**
     * 랜덤 이벤트11
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev11(int player_num)
    {
        String message="한 길거리 가수가 기타를 치며 노래를 부르고 있습니다.";
        ShowDialog(message);                                                                    
        String answer1="1.\'아름다운 음악이야.\'";
        ShowDialogAnswer(answer1,"11_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트12
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev12(int player_num)
    {
        String message="한 노인이 당신에게 말을 겁니다. \"신비한 물건을 찾고 있나?\"";
        ShowDialog(message);                                                                    
        String answer1="1. \"어떻게 아셨죠?\"";
        String answer2="2. 노인을 무시한다.";
        ShowDialogAnswer(answer1,"12_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"12_2",player_num);
    }
    /**
     * 랜덤 이벤트13
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev13(int player_num)
    {
        String message="당신은 이 도시가 다른 차원의 존재에 의해서 건설된 것이라는 문서를 보았다.";
        ShowDialog(message);                                                                    
        String answer1="1. (공포가 당신을 휘감는다.)";
        ShowDialogAnswer(answer1,"13_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트14
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev14(int player_num)
    {
        String message="\"앞, 뒤?\" 기괴한 차림새의 도박사가 묻는다.";
        ShowDialog(message);                                                                    
        String answer1="1. 앞.";
        String answer2="2. 뒤.";
        ShowDialogAnswer(answer1,"14_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"14_2",player_num);
    }
    /**
     * 랜덤 이벤트15
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev15(int player_num)
    {
        ...
        ShowDialog(message);                                                                    
        String answer1="1. \'심해 생물들이라고?\'";
        ShowDialogAnswer(answer1,"15_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트16
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev16(int player_num)
    {
        String message="폐가에 있는 오래된 일기를 읽고 무시무시하고 섬뜩한 비밀을 알게 되었습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. \'이런 비밀이.\'";
        ShowDialogAnswer(answer1,"16_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트17
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev17(int player_num)
    {
        String message="뉴스 헤드라인:\"고대의 유령선이 도시 상공에 나타났다!\"";
        ShowDialog(message);                                                                    
        String answer1="1. (진행)";
        ShowDialogAnswer(answer1,"17_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트18
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev18(int player_num)
    {
        String message="검은 정장의 사나이가 당신에게 거래를 제안합니다.";
        v.ShowDialog(message);                                                                    
        String answer1="1. 거래한다.";
        String answer2="2. 거래하지않는다.";
        v.ShowDialogAnswer(answer1,"18_1",player_num);                                                                 
        v.ShowDialogAnswer(answer2,"18_2",player_num);
    }
    /**
     * 랜덤 이벤트19
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev19(int player_num)
    {
        String message="뉴스 헤드라인:\"빈민가에서 연쇄살인 발생!\"";
        ShowDialog(message);                                                                    
        String answer1="1. (진행)";
        ShowDialogAnswer(answer1,"19_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트20
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev20(int player_num)
    {
        String message="바로 전에 당신의 방에 살았던 손님이 급히 서둘러 떠나느라 무언가를 남겨놓았습니다.";
        ShowDialog(message);                                                                    
        String answer1="1. \'쓸만한 물건인걸.\'";
        ShowDialogAnswer(answer1,"20_1",player_num);                                                                 
    }
    /**
     * 랜덤 이벤트21
     ...
     *        이벤트를 진행할 플레이어
     */
    public void Rev21(int player_num)
    {
        String message="무언가에 홀린듯한 호텔 지배인이 당신에게 스위트룸 숙박을 제안합니다. \"특가로 해드립죠.\"";
        ShowDialog(message);                                                                    
        String answer1="1. 제안을 받아들인다.";
        String answer2="2. 제안을 거절한다.";
        ShowDialogAnswer(answer1,"21_1",player_num);                                                                 
        ShowDialogAnswer(answer2,"21_2",player_num); 
    }
