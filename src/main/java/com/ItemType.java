...
public enum ItemType {
    ...
    POWDER_OF_EVEN_BRANCH("이븐의 가지 분말", 1, 1, 1, 0, 0, 3000),
    AMULET_OF_HOUND("사냥개 부적", 2, 2, 2, -2, -2, 1210),
    KEY_OF_WISDOM("지혜의 열쇠", 0, 0, 3, 0, 0, 451),
    SWEET_LIQUOR_OF_SPACE("우주의 감로주", 1, 1, 0, 2, 0, 1215),
    HEAD_OF_BLACK_PHARAOH("검은파라오의 단장", 0, 0, 0, 0, 1, 3501),
    LAMP_OF_ALHAZARD("알하자드의 램프", 0, 2, 1, 0, 0, 4512),
